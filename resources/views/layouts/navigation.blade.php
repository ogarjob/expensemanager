            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <Link class="font-bold text-blue-400 text-xl" href="{{ route('expenses.index') }}">
                            Expense Manager
                        </Link>
                    </div>
                    <!-- Navigation Links -->
                    ...
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                                <span class="mr-2">{{ ucwords(Auth::user()->name) }}</span>
                                    <img class="rounded-circle" src="{{ asset('images/undraw_profile.svg') }}" style="object-fit: cover;object-position: 50% 20%; height: 2rem; width: 2rem">
                            </button>
                        </x-slot>
                        <x-slot name="content">
