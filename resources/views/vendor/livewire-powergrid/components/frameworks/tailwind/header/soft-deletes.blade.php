@if(data_get($setUp, 'header.softDeletes'))
    ...
    <div x-data="{open: false}"
        ...
        <button @click.prevent="open = ! open"
            ...
            <div class="flex">
                <x-livewire-powergrid::icons.trash class="text-slate-500"/>
            </div>
        </button>
        ...
        <div x-show="open"
            ...
            <div x-on:click="$wire.emit('pg:softDeletes-{{ $tableName }}', ''); open = false"
                 class="cursor-pointer flex justify-start block px-4 py-2 text-slate-800 hover:bg-slate-50 hover:text-black-200">
